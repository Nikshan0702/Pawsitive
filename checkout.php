   ...
   if($cart_query && $detail_query){
      ...
      <div class='message-container'>
         ...
         <div class='customer-details'>
            ...
            <a href='review.php' class='btn'>Leave a Review</a> <!-- This is the new button for reviews -->
         </div>
      </div>
      ";
   }
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>country</span>
            <input type="text" placeholder="e.g. ceylon" name="country" required>
         </div>
         <div class="inputBox">
            <span>pin code</span>
            <input type="text" placeholder="e.g. 123456" name="pin_code" required style="width: 200px; height: 50ppx;">
         </div>
      </div>
